...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        #self.base_residual_scaler = nn.Parameter(torch.ones(len(self.down_blocks)+1))
    ...
    def forward(
        ...
        if down_block_additional_residuals is not None:
            ...
            for i, (down_block_res_sample, down_block_additional_residual) in enumerate(zip(
                down_block_res_samples, down_block_additional_residuals
            )):
                #down_block_res_sample = down_block_res_sample*self.base_residual_scaler[i] + down_block_additional_residual
        ...
        if mid_block_additional_residual is not None:
            #sample = sample*self.base_residual_scaler[-1] + mid_block_additional_residual
